...
df = pd.read_csv("aquivo_final.csv")  # Lê o arquivo CSV e armazena os dados em um DataFrame
...
plt.title('Relação entre Média em Algoritmos e Frequência (2018.01)')  # Adiciona o título do gráfico

...
df = pd.read_csv("202401-V1.csv")  # Lê o arquivo CSV e armazena os dados em um DataFrame
...
plt.title('Relação entre Média em Algoritmos e Frequência (2024.01)')  # Adiciona o título do gráfico

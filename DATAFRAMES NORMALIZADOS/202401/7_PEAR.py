...
from scipy.stats import pearsonr  # Importa a função pearsonr para calcular o coeficiente de Pearson

# Carregar os dados do CSV
df = pd.read_csv("202401-VF.csv")  # Lê o arquivo CSV e armazena os dados em um DataFrame
...
plt.title('Relação entre Média em Algoritmos e Frequência (2022.01)')  # Adiciona o título do gráfico
